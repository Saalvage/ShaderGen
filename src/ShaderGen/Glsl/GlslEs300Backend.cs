...
namespace ShaderGen.Glsl
{
    public class GlslEs300Backend : GlslBackendBase
    {
        ...
        public GlslEs300Backend(Compilation compilation) : base(compilation, DefaultOptions)
        {
        }

        public GlslEs300Backend(Compilation compilation, GlslOptions options) : base(compilation, options)
        {
        }
